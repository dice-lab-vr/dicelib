...
parser.add_argument("--QB_threshold", type=float32, default=10, help=" Threshold to use in QuickBundles")
parser.add_argument("--suffix",default="", help="Suffix to name the output files")
